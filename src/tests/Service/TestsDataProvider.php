...
class TestsDataProvider
{
    private static $tournaments = [
        ...
        'largeDoubleLocal' => [100, 100, 95, 95, 91, 91, 87, 87, 83, 83, 79, 79, 75, 75, 71, 71, 67, 67, 62, 62, 58, 58, 54, 54, 50, 50, 46, 46, 42, 42, 38, 38, 34, 34, 29, 29, 25, 25, 21, 21, 17, 17, 13, 13, 9, 9, 5, 5, 1, 1],
        ...
        'largeDoubleMaster' => [300, 300, 280, 280, 262, 262, 246, 246, 230, 230, 216, 216, 202, 202, 189, 189, 177, 177, 164, 164, 153, 153, 141, 141, 130, 130, 118, 118, 107, 107, 96, 96, 86, 86, 75, 75, 64, 64, 53, 53, 43, 43, 32, 32, 22, 22, 11, 11, 1, 1],
    ...
    public static function getLargeDoubleLocalTestData() : array
    {
        return self::getTournamentTestData('largeDoubleLocal', 2);
    }
    ...
    public static function getLargeDoubleMasterTestData() : array
    {
        return self::getTournamentTestData('largeDoubleMaster', 2, 'master');
    }
    ...
    private static function getExpectedResults($inputData, $playersInTeam, $rank) : array
    {
        ...
        foreach ($inputData as $i => $expectedResult) {
            ...
            $newResult->setTournamentType($playersInTeam == 1 ? 'single' : ( $playersInTeam == 2 ? 'double' : 'team'));
